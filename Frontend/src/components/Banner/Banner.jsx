...
Farm to you, bringing nature near!"
     ...
     <input type="text" className="grow" placeholder="Email" />
        ...
        <button className="mt-5 btn btn-success">Contact Us</button>
     

        </div>
        
        <div className="md:order-2 order-1 mt-12 md:mt-26 w-full md:w-1/2">
        <img className="md:m-4 flex w-92 h-92" src={img} alt=""/>
        </div>
    </div>
    </>
  )
